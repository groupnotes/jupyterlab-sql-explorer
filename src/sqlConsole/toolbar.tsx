...
class RunStatusComponent extends React.Component<IRunStatusOptions, IRunStatusState> {
...
export class RunStatus extends ReactWidget {
    ...
    render(): JSX.Element {
        return <RunStatusComponent model={this._queryModel} trans={this._trans} onChange={this._onChange}/>
    }
